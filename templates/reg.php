          ...
          <form class="form" action="/register.php" method="post" autocomplete="off">
            <div class="form__row">
              ...
              <input class="form__input <?php if(!empty($errors['email'])) : ?>form__input--error<?php endif ?>" type="text" name="email" id="email" value="<?=$data['email'] ?? ""?>" placeholder="Введите e-mail">
            ...
            <div class="form__row">
              ...
              <input class="form__input <?php if(!empty($errors['name'])) : ?>form__input--error<?php endif ?>" type="text" name="name" id="name" value="<?=$data['name'] ?? ""?>" placeholder="Введите пароль">
